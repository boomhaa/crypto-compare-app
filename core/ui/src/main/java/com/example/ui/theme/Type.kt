...
val ChartLabelTypography = TextStyle(
    fontFamily = NumberFontFamily,
    fontWeight = FontWeight.Medium,
    fontSize = 11.sp,
    lineHeight = 14.sp,
...
val NavigationLabelTypography = TextStyle(
    fontFamily = TextFontFamily,
    fontWeight = FontWeight.SemiBold,
    fontSize = 10.sp,
    lineHeight = 14.sp,
...
val SectionHeaderTypography = TextStyle(
    fontFamily = TextFontFamily,
    fontWeight = FontWeight.SemiBold,
    fontSize = 18.sp,
    lineHeight = 24.sp,
